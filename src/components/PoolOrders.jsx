...
export default function SaunaOrders() {
    ...
    const emptyRows =
        page > 0 ? Math.max(0, (1 + page) * rowsPerPage - response?.filter(item => item.sauna !== null)?.length) : 0;
            ...
            <Table sx={{minWidth: '100%'}} aria-label="simple table">
                ...
                <TableBody>
                    {(rowsPerPage > 0
                            ...
                            : response
                    )?.filter(item => item.sauna !== null).toReversed().map((row) => (
                        <TableRow
                            key={row.id}
                            sx={{
                ...
                <TableFooter>
                    <TableRow>
                        <TablePagination
                            ...
                            colSpan={10}
                            count={response?.filter(item => item.sauna !== null)?.length}
