...
export default function CreateTrainingOrder({filterParams, setFilterParams}) {
    ...
    const createOrder = async () => {
        const {response} = await createOrderRequest.request({
            data: {
                ...
                summ: price || '0',
                debt: debt ? debt : '0',
                phone: phone || '+998711234567',
                relax: relax,
                sauna: null,
                pool: null,
                training: typeNumber.id,
                billiard: null,
                shortsNumber: shorts ? shorts : '0',
                subscription: chooseSubscription.id || null,
